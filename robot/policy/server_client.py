...
from robot.config.data import ModalityConfig
from robot.utils import serialize_for_json as to_json_serializable

from .robot_policy import SimRobotPolicy
...
class PolicyServer:
    ...
    def __init__(
        self, policy: SimRobotPolicy, host: str = "*", port: int = 5555, api_token: str = None
    ):
        self.policy = policy
        self.running = True
    ...
    @staticmethod
    def start_server(policy: SimRobotPolicy, port: int, api_token: str = None):
